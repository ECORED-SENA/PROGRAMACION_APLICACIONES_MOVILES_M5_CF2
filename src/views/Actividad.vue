  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Actividad didáctica: Identificar conceptos y componentes por medio de emparejamiento entre término y definición.
        p.mb-4 Objetivo: Generar un repaso de los conceptos socializados, identificando las herramientas y etapas para el desarrollo de una aplicación móvil.
